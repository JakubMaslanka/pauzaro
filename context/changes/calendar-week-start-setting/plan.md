...
- [x] 3.1 TypeScript compiles: `pnpm tsc --noEmit` — f977687
- [x] 3.2 All tests pass (including new): `pnpm test` — f977687
- [x] 3.3 Lint passes: `pnpm lint` — f977687
- [x] 3.4 Rust check still passes: `cd src-tauri && cargo check` — f977687
